; file: lib/printf.asm      target: ATmega128L-4MHz-STK300
...
; Print formatted
; Entry point to the printf module.
; @0: a "putc" function label to handle characters in a0
.macro  PRINTF
    ldi     w, low(@0)
    mov     e0,w
    ldi     w, high(@0)
...
_div41:
    ...
    ldi     w, 32               ; load bit counter
__d41:
    ROL5    d0, a3, a2, a1, a0  ; shift carry into result c
